...
{
	return glImportSemaphoreWin32HandleEXT(gl_semaphore, gl_handle_type, ext_semaphore_handle);
}
...
{
	return glImportMemoryWin32HandleEXT(memory, size, handle_type, ext_semaphore_handle);
}
