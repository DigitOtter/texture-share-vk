...
//	std::array<u_char, 8 * 8 * 4> sent_data;
//	std::array<u_char, 8 * 8 * 4> ret_data;
...
//	glGetTextureImage(tex_1, 0, GL_RGBA, GL_UNSIGNED_BYTE, 8 * 8 * 4, sent_data.data());
//	std::cout << GetGLErrorStr(glGetError()) << std::endl;

//	client.SendImageBlit(img_1_name, tex_1, GL_TEXTURE_2D,
//	                     {
//							 {0, 0},
//							 {8, 8}
//    });
...
//	client.RecvImageBlit(img_1_name, tex_2, GL_TEXTURE_2D,
//	                     {
//							 {4, 4},
//							 {8, 8}
//    });
...
//	glGetTextureImage(tex_2, 0, GL_RGBA, GL_UNSIGNED_BYTE, 8 * 8 * 4, ret_data.data());
//	std::cout << GetGLErrorStr(glGetError()) << std::endl;
...
int main(int argc, char **argv)
{
	...
	while(!client.FindImage("image_name"))
	{
		sleep(1);
	}

	client.RecvImageBlit("image_name", tex_2, GL_TEXTURE_2D,
	                     {
							 {0, 0},
							 {8, 8}
    });
