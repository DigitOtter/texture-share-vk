...
void ExternalHandleGl::ImportSemaphoreExt(GLuint gl_semaphore, GLenum gl_handle_type,
...
void ExternalHandleGl::ImportMemoryExt(GLuint memory, GLuint64 size, GLenum handle_type,
                                       ExternalHandle::TYPE ext_semaphore_handle)
{
